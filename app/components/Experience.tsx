  ...
  const experiences = [
    {
      ...
      type: "Completed",
      description: [
        "Worked on Aerospace Projects like Rockets",
        "Gained Proficiency in Avionics, Drones etc.",
        "Explored Aerospace systems in terms of Designing, Troubleshooting and NPD",
      ],
